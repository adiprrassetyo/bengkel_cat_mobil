<!doctype html>  
	...
	<body> 
		...
		<div class="container-lg mt-5 ">
			<div class="row">
				<div class="col">
					<a href="/my-vehicle/{{ auth()->user()->id }}/{{ auth()->user()->nik }}" class="text-decoration-none back"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
				</div>
			</div>
		</div>
				...
				<div class="col-md-4 mb-4">
					<div class="card shadow">
						<div class="card-body data-container">
							...
							<p class="data-kendaraan text-center">{{ $vehicle->user->nama }}</p>
							@else
													...
													<td>
														<div class="dropdown">
															...
															<ul class="dropdown-menu " aria-labelledby="dropdownMenuButton2">
																<li><a class="dropdown-item " href="/show-myVehicle-repairs/{{ $data->id }}/{{ $data->kode_perbaikan }}"><i class="bi me-2 bi-eye-fill"></i>Lihat</a></li>
															</ul>
														</div>
													</td>
												</tr>
